...
public class AttoSeguidorBlock extends TranslatorBlock
{
	...
	public AttoSeguidorBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
