...
public class AttoUltrassonicBlock extends TranslatorBlock
{
	public AttoUltrassonicBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
