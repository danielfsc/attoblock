...
public class AttoButtonBlock extends TranslatorBlock
{
	...
	public AttoButtonBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
