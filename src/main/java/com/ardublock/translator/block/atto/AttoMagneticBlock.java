...
public class AttoMagneticBlock extends TranslatorBlock
{
	...
	public AttoMagneticBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
