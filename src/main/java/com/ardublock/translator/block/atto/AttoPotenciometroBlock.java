...
public class AttoPotenciometroBlock extends TranslatorBlock
{
	...
	public AttoPotenciometroBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
