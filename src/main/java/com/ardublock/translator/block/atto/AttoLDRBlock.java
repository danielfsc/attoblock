...
public class AttoLDRBlock extends TranslatorBlock
{
	...
	public AttoLDRBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
