...
public class AttoServoBlock extends TranslatorBlock
{

	public AttoServoBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
