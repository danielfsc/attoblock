...
public class Atto_Hooke extends TranslatorBlock
{
	...
	public String toCode() throws SocketNullException , SubroutineNotDeclaredException
	{
		...
		if(ultrassonic_block.toCode().equals(ultra_block) == ultrassonic_block.toCode().equals("7")){
			String lei_hooke = "if (__ardublockDigitalReadHooke("+botao_zera+"))\n {\n  _ABVAR_1_Zerado = ardublockUltrasonicMesure( 6 , "+ultra_block+" , 0 )  ;\n Serial.print(\"Ajustado\");\n Serial.print(\" \"); \n Serial.print(( _ABVAR_1_Zerado - _ABVAR_1_Zerado ));\n Serial.print(\" \");\n  Serial.println();\n delay("+delay_string+");\n }\n if (__ardublockDigitalReadHooke("+botao_liga+")) \n{\n  _ABVAR_2_Double = ( _ABVAR_1_Zerado - ardublockUltrasonicMesure( 6 , "+ultra_block+" , 0 )  ) ; \nSerial.print(_ABVAR_2_Double);\nSerial.print(\"\");\nSerial.print(\"cm\");\nSerial.print(\"\");\nSerial.println(\"\");\n delay( "+delay_string+" );\n}\n";
			return codePrefix + lei_hooke + codeSuffix;	
		}
		if(ultrassonic_block.toCode().equals(ultra_block) == ultrassonic_block.toCode().equals("5")){
			String lei_hooke = "if (__ardublockDigitalReadHooke("+botao_zera+"))\n {\n  _ABVAR_1_Zerado = ardublockUltrasonicMesure( 4 , "+ultra_block+" , 0 )  ;\n Serial.print(\"Ajustado\");\n Serial.print(\" \"); \n Serial.print(( _ABVAR_1_Zerado - _ABVAR_1_Zerado ));\n Serial.print(\" \");\n  Serial.println();\n delay("+delay_string+");\n }\n if (__ardublockDigitalReadHooke("+botao_liga+")) \n{\n  _ABVAR_2_Double = ( _ABVAR_1_Zerado - ardublockUltrasonicMesure( 4 , "+ultra_block+" , 0 )  ) ; \nSerial.print(_ABVAR_2_Double);\nSerial.print(\"\");\nSerial.print(\"cm\");\nSerial.print(\"\");\nSerial.println(\"\");\n delay( "+delay_string+" );\n}\n";
			return codePrefix + lei_hooke + codeSuffix;	
		}
		if(ultrassonic_block.toCode().equals(ultra_block) == ultrassonic_block.toCode().equals("3")){
			String lei_hooke = "if (__ardublockDigitalReadHooke("+botao_zera+"))\n {\n  _ABVAR_1_Zerado = ardublockUltrasonicMesure( 2 , "+ultra_block+" , 0 )  ;\n Serial.print(\"Ajustado\");\n Serial.print(\" \"); \n Serial.print(( _ABVAR_1_Zerado - _ABVAR_1_Zerado ));\n Serial.print(\" \");\n  Serial.println();\n delay("+delay_string+");\n }\n if (__ardublockDigitalReadHooke("+botao_liga+")) \n{\n  _ABVAR_2_Double = ( _ABVAR_1_Zerado - ardublockUltrasonicMesure( 2 , "+ultra_block+" , 0 )  ) ; \nSerial.print(_ABVAR_2_Double);\nSerial.print(\"\");\nSerial.print(\"cm\");\nSerial.print(\"\");\nSerial.println(\"\");\n delay( "+delay_string+" );\n}\n";
			return codePrefix + lei_hooke + codeSuffix;	
		}
