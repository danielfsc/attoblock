...
public class atto_segLeiNewton extends TranslatorBlock
{
	public atto_segLeiNewton(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException , SubroutineNotDeclaredException
	{
		...
		######################################################################*/
			...
			String variaveis_globais = "double Decimal = 0.0; \n bool funcaoA_newton= false ; \n";
