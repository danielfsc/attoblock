...
public class Atto_MRU extends TranslatorBlock
{
	public Atto_MRU(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
