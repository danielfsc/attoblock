...
public class Atto_osc_forca extends TranslatorBlock
{
	public Atto_osc_forca(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
